...
class App < Sinatra::Base
  configure do # these lines are enabling our application to use the sessions keyword to access the session hash
    enable :sessions unless test?
    set :session_secret, "secret" # we are also setting a session secret, keeps our session data safe from outsiders
  end
